...
void test_free_two_blocks() {
    debug("\n\nTest 3: success_free_two_blocks run...\n");
...
void test_expand_filled_region() {
    debug("\n\nTest 5: test_expand_filled_region...\n");
