...
int main() {
    struct AST* ast1 = binop(BIN_PLUS, lit(999), lit(728));
    print(stdout, ast1);
    printf("\n");
    struct AST* ast2 = binop(BIN_PLUS, lit(4), binop(BIN_MUL, lit(2), lit(9)));
    print(stdout, ast2);
    printf("\n");
    struct AST* ast3 = binop(BIN_MUL, binop(BIN_PLUS, lit(3), lit(5)), divide(lit(9), lit(7)));
    print(stdout, ast3);
    printf("\n");
    return 0;
}