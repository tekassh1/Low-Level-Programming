...
//     printf("Bits per pixel: %" PRIu16 "\n", header->biBitCount);
//     printf("Compression: %" PRIu32 "\n", header->biCompression);
//     printf("Image size: %" PRIu32 "\n", header->biSizeImage);
//     printf("X pixels per meter: %" PRIu32 "\n", header->biXPelsPerMeter);
//     printf("Y pixels per meter: %" PRIu32 "\n", header->biYPelsPerMeter);
//     printf("Colors used: %" PRIu32 "\n", header->biClrUsed);
//     printf("Important colors: %" PRIu32 "\n", header->biClrImportant);
//     printf("\n\n");
// }
